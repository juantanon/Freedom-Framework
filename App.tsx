              ...
              {issues.map(issue => (
                <div key={issue.id} style={styles.issueRow}>
                  ...
                  <div style={{marginLeft: '20px'}}>
                     <button onClick={() => startSimplifiedPrayer(issue.text)} style={styles.btnSmall}>Pray &rarr;</button>
                  </div>
                </div>
              ))}
            </div>
      ...
      <div style={styles.prayerContainer}>
        ...
        {activePrayer === 'FREEDOM' && (
          <div style={styles.prayerText}>
            ...
            {prayerMode === 'SELF' ? (
              <>
                <p>“Lord Jesus, I repent of my sins. I want freedom from my burdens and I ask you to help me...</p>
                ...
                <p>“And now, in Jesus’ name, I command every unholy spirit to leave me immediately. Amen!”</p>
              </>
            ) : (
              <>
                 <p>“Lord Jesus, I come before you on <strong>{getName()}'s</strong> behalf...</p>
                 <h3>1. Unforgiveness</h3>
                 ...
                 <div style={styles.variableBlockBlank}>_______________________________</div>
                 <h3>Closing Command</h3>
                 <p>“And now, in Jesus’ name, I command every unholy spirit to leave <strong>{getName()}</strong> immediately. Amen!”</p>
              </>
            )}
          </div>
        )}
        ...
        {activePrayer === 'SIMPLIFIED' && (
           <div style={styles.prayerText}>
             ...
             <div style={styles.nameInputBlock}><p><strong>Targeting:</strong> {getTargetIssue()}</p></div>
             {prayerMode === 'SELF' ? (
               <>
                 <p>“Lord Jesus, I repent of my sins. I want freedom from <strong>{getTargetIssue()}</strong>...</p>
                 <div style={styles.variableBlock}>{getList('unforgiveness')}</div>
                 <div style={styles.variableBlock}>{getList('sexual_sin')}</div>
                 <p>“I also speak to the <strong>{getSpiritLabel()}</strong> of <strong>{getTargetIssue()}</strong> and I command you to go as well. Amen!”</p>
               </>
             ) : (
                <>
                  <p>“Lord Jesus, I come before you on <strong>{getName()}'s</strong> behalf to help {getHimHer()} with <strong>{getTargetIssue()}</strong>...</p>
                  <div style={styles.variableBlockBlank}>_______________________________</div>
                  <p>“I also speak to the <strong>{getSpiritLabel()}</strong> of <strong>{getTargetIssue()}</strong> and I command you to go. Amen!”</p>
                </>
             )}
           </div>
        )}
        ...
        {activePrayer === 'DAILY' && (
           <div style={styles.prayerText}>
             ...
             <p>Heavenly Father, I come to you in Jesus’ name...</p>
             <div style={styles.variableBlock}>{getList('unforgiveness')}</div>
