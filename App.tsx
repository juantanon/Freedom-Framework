...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  error: { color: '#ef4444', marginTop: '16px', fontSize: '14px' }, // FIXED: Added closing quote and comma

  // Tracker Specifics
  trackerBox: { backgroundColor: 'white', padding: '24px', borderRadius: '16px', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)', marginBottom: '32px' },
  trackerForm: { display: 'flex', gap: '12px' },
  trackerInput: { flex: 1, padding: '12px 16px', borderRadius: '8px', border: '1px solid #e5e7eb', fontSize: '16px' },
  trackerButton: { backgroundColor: '#10b981', color: 'white', border: 'none', padding: '12px 24px', borderRadius: '8px', fontWeight: 'bold', cursor: 'pointer' },
  issuesList: { display: 'flex', flexDirection: 'column', gap: '12px' },
  issueRow: { backgroundColor: 'white', padding: '16px', borderRadius: '12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', border: '1px solid #f3f4f6' },
  date: { fontSize: '12px', color: '#9ca3af', marginRight: '12px' },
  issueText: { fontSize: '16px', color: '#374151' },
  deleteX: { background: 'none', border: 'none', color: '#ef4444', fontSize: '20px', cursor: 'pointer', padding: '0 8px' },
  emptyState: { color: '#9ca3af', fontStyle: 'italic', marginTop: '24px' }
};
